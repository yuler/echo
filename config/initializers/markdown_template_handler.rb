...
ActionView::Template.register_template_handler("md.erb", ->(template, source) {
  ...
  <<~RUBY
    ...
    ('<div class="markdown-body max-w-[1200px] mx-auto px-6 pt-10 !font-serif prose prose-neutral prose-lg md:prose-xl prose-headings:font-bold prose-headings:tracking-tight prose-a:text-blue-600 hover:prose-a:text-blue-500 selection:bg-blue-100 selection:text-blue-900">' + html + "</div>").html_safe
  RUBY
})
